...
public class TorBoxDebridClientTest
{
    ...
    public async Task AddNzbFile_CallsUsenetAddFileAsyncWithName()
    {
        ...
        usenetApiMock.Setup(m => m.AddFileAsync(bytes, It.IsAny<Int32>(), name, null, It.IsAny<CancellationToken>()))
        ...
        usenetApiMock.Verify(m => m.AddFileAsync(bytes, It.IsAny<Int32>(), name, null, It.IsAny<CancellationToken>()), Times.Once);
    }
    [Fact]
